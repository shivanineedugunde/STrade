...
import com.project.strade.ui.fragments.home.HomeFragmentDirections;
...
public class AllItemsAdapter extends RecyclerView.Adapter<AllItemsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.item_address.setText(items.get(position).getLocation());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            item_address = itemView.findViewById(R.id.itemAddressTxt);

package com.project.strade.ui.fragments.help;
...
import com.project.strade.databinding.FragmentHelpFeedbackBinding;
...
public class HelpFeedbackFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.buttonSubmitFeedback.setOnClickListener(v -> {
            ...
            intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"project@gmail.com"});

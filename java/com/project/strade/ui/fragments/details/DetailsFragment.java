package com.project.strade.ui.fragments.details;
...
import com.project.strade.databinding.FragmentDetailsBinding;
...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.messageButton.setOnClickListener(v -> {
            ...
            String sms = "Hey. I have seen you are selling " + data.getItemName() + ". Can we trade.";//The message you want to text to the phone
        ...
        binding.whatsappButton.setOnClickListener(v -> {
            ...
            intent.setData(Uri.parse(url + "&text=" + "Hey. I have seen you are selling " + data.getItemName() + ". Can we trade."));
            startActivity(intent);
            Timber.d(phone);
        });
